...
class PagedModelUserNotification {
  /// Returns a new [PagedModelUserNotification] instance.
  ...
  /// Returns a new [PagedModelUserNotification] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static PagedModelUserNotification? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return PagedModelUserNotification(
  ...
  static List<PagedModelUserNotification> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = PagedModelUserNotification.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, PagedModelUserNotification> mapFromJson(dynamic json) {
    final map = <String, PagedModelUserNotification>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = PagedModelUserNotification.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
