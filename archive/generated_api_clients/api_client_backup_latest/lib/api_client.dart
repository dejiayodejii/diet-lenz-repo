...
class ApiClient {
  ApiClient({
    this.basePath = 'https://diet-lenz-stagingapi-d3mbl.ondigitalocean.app',
    this.authentication,
  });
  ...
  static dynamic fromJson(
    ...
    try {
      switch (targetType) {
        ...
        case 'LogMealRequestDto':
          return LogMealRequestDto.fromJson(value);
        case 'LoginRequest':
          return LoginRequest.fromJson(value);
        case 'LoginWithDeviceRequest':
        ...
        case 'PagedModelMealLogResponseDto':
          return PagedModelMealLogResponseDto.fromJson(value);
