...
// tests for OnboardingSurveyRequest
void main() {
  // final instance = OnboardingSurveyRequest();

  group('test OnboardingSurveyRequest', () {
    // String hearAboutUs
    ...
    // List<String> allergenExclusions (default value: const [])
