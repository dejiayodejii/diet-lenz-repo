...
class MacroResult {
  ...
  @override
  String toString() =>
      'MacroResult[totalCalories=$totalCalories, proteinGrams=$proteinGrams, carbsGrams=$carbsGrams, fatGrams=$fatGrams, fiberGrams=$fiberGrams]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "MacroResult[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "MacroResult[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MacroResult> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MacroResult>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MacroResult.listFromJson(
          entry.value,
          growable: growable,
        );
      }
