...
class ChangePasswordRequest {
  ...
  @override
  String toString() =>
      'ChangePasswordRequest[currentPassword=$currentPassword, newPassword=$newPassword, confirmPassword=$confirmPassword]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ChangePasswordRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ChangePasswordRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ChangePasswordRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ChangePasswordRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ChangePasswordRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
