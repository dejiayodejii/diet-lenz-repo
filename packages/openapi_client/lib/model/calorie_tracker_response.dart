...
class CalorieTrackerResponse {
  /// Returns a new [CalorieTrackerResponse] instance.
  ...
  /// Returns a new [CalorieTrackerResponse] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CalorieTrackerResponse? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<CalorieTrackerResponse> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CalorieTrackerResponse.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CalorieTrackerResponse> mapFromJson(dynamic json) {
    final map = <String, CalorieTrackerResponse>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CalorieTrackerResponse.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
