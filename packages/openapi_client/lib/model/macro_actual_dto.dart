...
class MacroActualDto {
  /// Returns a new [MacroActualDto] instance.
  MacroActualDto({
    this.calories,
    this.proteinGrams,
    this.carbsGrams,
  ...
  /// Returns a new [MacroActualDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MacroActualDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MacroActualDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MacroActualDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MacroActualDto> mapFromJson(dynamic json) {
    final map = <String, MacroActualDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MacroActualDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
