...
class OnboardingSurveyRequest {
  ...
  bool operator ==(Object other) =>
      ...
      other is OnboardingSurveyRequest &&
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "OnboardingSurveyRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "OnboardingSurveyRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return OnboardingSurveyRequest(
        hearAboutUs: OnboardingSurveyRequestHearAboutUsEnum.fromJson(
            json[r'hearAboutUs']),
        referralCode: mapValueOfType<String>(json, r'referralCode'),
        desiredGoal: OnboardingSurveyRequestDesiredGoalEnum.fromJson(
            json[r'desiredGoal'])!,
        ...
        heightUnit: OnboardingSurveyRequestHeightUnitEnum.fromJson(
            json[r'heightUnit'])!,
        currentWeight: mapValueOfType<int>(json, r'currentWeight')!,
        currentWeightUnit:
            OnboardingSurveyRequestCurrentWeightUnitEnum.fromJson(
                json[r'currentWeightUnit'])!,
        activityLevel: OnboardingSurveyRequestActivityLevelEnum.fromJson(
            json[r'activityLevel'])!,
        allergenExclusions: json[r'allergenExclusions'] is Iterable
            ? (json[r'allergenExclusions'] as Iterable)
                .cast<String>()
                .toList(growable: false)
            : const [],
        targetEvent: OnboardingSurveyRequestTargetEventEnum.fromJson(
            json[r'targetEvent']),
        targetEventDate: mapDateTime(json, r'targetEventDate', r''),
        desiredWeight: mapValueOfType<int>(json, r'desiredWeight')!,
        desiredWeightUnit:
            OnboardingSurveyRequestDesiredWeightUnitEnum.fromJson(
                json[r'desiredWeightUnit'])!,
        goalPace:
            OnboardingSurveyRequestGoalPaceEnum.fromJson(json[r'goalPace'])!,
        biggestChallenge: OnboardingSurveyRequestBiggestChallengeEnum.fromJson(
            json[r'biggestChallenge']),
        notificationsEnabled:
            mapValueOfType<bool>(json, r'notificationsEnabled'),
        mealRemindersEnabled:
            mapValueOfType<bool>(json, r'mealRemindersEnabled'),
        healthSyncSettings:
            HealthSyncSettingsDto.fromJson(json[r'healthSyncSettings'])!,
  ...
  static List<OnboardingSurveyRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<OnboardingSurveyRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = OnboardingSurveyRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
class OnboardingSurveyRequestHearAboutUsEnum {
  ...
  static const FROM_INFLUENCER =
      OnboardingSurveyRequestHearAboutUsEnum._(r'FROM_INFLUENCER');
  static const INSTAGRAM =
      OnboardingSurveyRequestHearAboutUsEnum._(r'INSTAGRAM');
  ...
  static const APP_STORE_SEARCH =
      OnboardingSurveyRequestHearAboutUsEnum._(r'APP_STORE_SEARCH');
  static const FRIEND_FAMILY =
      OnboardingSurveyRequestHearAboutUsEnum._(r'FRIEND_FAMILY');
  ...
  static OnboardingSurveyRequestHearAboutUsEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestHearAboutUsEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestHearAboutUsEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestHearAboutUsEnumTypeTransformer {
  factory OnboardingSurveyRequestHearAboutUsEnumTypeTransformer() =>
      _instance ??=
  ...
  OnboardingSurveyRequestHearAboutUsEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        ...
        case r'OTHER':
          return OnboardingSurveyRequestHearAboutUsEnum.OTHER;
        default:
          if (!allowNull) {
...
class OnboardingSurveyRequestDesiredGoalEnum {
  ...
  static const LOSE_WEIGHT =
      OnboardingSurveyRequestDesiredGoalEnum._(r'LOSE_WEIGHT');
  static const MAINTAIN_WEIGHT =
      OnboardingSurveyRequestDesiredGoalEnum._(r'MAINTAIN_WEIGHT');
  static const GAIN_WEIGHT =
      OnboardingSurveyRequestDesiredGoalEnum._(r'GAIN_WEIGHT');
  ...
  static OnboardingSurveyRequestDesiredGoalEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestDesiredGoalEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestDesiredGoalEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestDesiredGoalEnumTypeTransformer {
  factory OnboardingSurveyRequestDesiredGoalEnumTypeTransformer() =>
      _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestDesiredGoalEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'LOSE_WEIGHT':
...
class OnboardingSurveyRequestGenderEnum {
  ...
  static OnboardingSurveyRequestGenderEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestGenderEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestGenderEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestGenderEnumTypeTransformer {
  factory OnboardingSurveyRequestGenderEnumTypeTransformer() =>
      _instance ??= const OnboardingSurveyRequestGenderEnumTypeTransformer._();
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestGenderEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'MALE':
...
class OnboardingSurveyRequestHeightUnitEnum {
  ...
  static OnboardingSurveyRequestHeightUnitEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestHeightUnitEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestHeightUnitEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestHeightUnitEnumTypeTransformer {
  factory OnboardingSurveyRequestHeightUnitEnumTypeTransformer() =>
      _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestHeightUnitEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'CM':
          return OnboardingSurveyRequestHeightUnitEnum.CM;
        case r'FT':
          return OnboardingSurveyRequestHeightUnitEnum.FT;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class OnboardingSurveyRequestCurrentWeightUnitEnum {
  ...
  static const POUNDS =
      OnboardingSurveyRequestCurrentWeightUnitEnum._(r'POUNDS');
  ...
  static OnboardingSurveyRequestCurrentWeightUnitEnum? fromJson(
          dynamic value) =>
      OnboardingSurveyRequestCurrentWeightUnitEnumTypeTransformer()
          .decode(value);

  static List<OnboardingSurveyRequestCurrentWeightUnitEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            OnboardingSurveyRequestCurrentWeightUnitEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class OnboardingSurveyRequestCurrentWeightUnitEnumTypeTransformer {
  factory OnboardingSurveyRequestCurrentWeightUnitEnumTypeTransformer() =>
      _instance ??=
          const OnboardingSurveyRequestCurrentWeightUnitEnumTypeTransformer._();

  const OnboardingSurveyRequestCurrentWeightUnitEnumTypeTransformer._();

  String encode(OnboardingSurveyRequestCurrentWeightUnitEnum data) =>
      data.value;
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestCurrentWeightUnitEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'KG':
          return OnboardingSurveyRequestCurrentWeightUnitEnum.KG;
        case r'POUNDS':
          return OnboardingSurveyRequestCurrentWeightUnitEnum.POUNDS;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class OnboardingSurveyRequestActivityLevelEnum {
  ...
  static const SEDENTARY =
      OnboardingSurveyRequestActivityLevelEnum._(r'SEDENTARY');
  static const LIGHTLY_ACTIVE =
      OnboardingSurveyRequestActivityLevelEnum._(r'LIGHTLY_ACTIVE');
  static const MODERATELY_ACTIVE =
      OnboardingSurveyRequestActivityLevelEnum._(r'MODERATELY_ACTIVE');
  static const VERY_ACTIVE =
      OnboardingSurveyRequestActivityLevelEnum._(r'VERY_ACTIVE');
  static const EXTRA_ACTIVE =
      OnboardingSurveyRequestActivityLevelEnum._(r'EXTRA_ACTIVE');
  ...
  static OnboardingSurveyRequestActivityLevelEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestActivityLevelEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestActivityLevelEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestActivityLevelEnumTypeTransformer {
  factory OnboardingSurveyRequestActivityLevelEnumTypeTransformer() =>
      _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestActivityLevelEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'SEDENTARY':
...
class OnboardingSurveyRequestTargetEventEnum {
  ...
  static const PERSONAL_MILESTONE =
      OnboardingSurveyRequestTargetEventEnum._(r'PERSONAL_MILESTONE');
  ...
  static OnboardingSurveyRequestTargetEventEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestTargetEventEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestTargetEventEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestTargetEventEnumTypeTransformer {
  factory OnboardingSurveyRequestTargetEventEnumTypeTransformer() =>
      _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestTargetEventEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'VACATION':
...
class OnboardingSurveyRequestDesiredWeightUnitEnum {
  ...
  static const POUNDS =
      OnboardingSurveyRequestDesiredWeightUnitEnum._(r'POUNDS');
  ...
  static OnboardingSurveyRequestDesiredWeightUnitEnum? fromJson(
          dynamic value) =>
      OnboardingSurveyRequestDesiredWeightUnitEnumTypeTransformer()
          .decode(value);

  static List<OnboardingSurveyRequestDesiredWeightUnitEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            OnboardingSurveyRequestDesiredWeightUnitEnum.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
...
class OnboardingSurveyRequestDesiredWeightUnitEnumTypeTransformer {
  factory OnboardingSurveyRequestDesiredWeightUnitEnumTypeTransformer() =>
      _instance ??=
          const OnboardingSurveyRequestDesiredWeightUnitEnumTypeTransformer._();

  const OnboardingSurveyRequestDesiredWeightUnitEnumTypeTransformer._();

  String encode(OnboardingSurveyRequestDesiredWeightUnitEnum data) =>
      data.value;
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestDesiredWeightUnitEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'KG':
          return OnboardingSurveyRequestDesiredWeightUnitEnum.KG;
        case r'POUNDS':
          return OnboardingSurveyRequestDesiredWeightUnitEnum.POUNDS;
        default:
          if (!allowNull) {
            throw ArgumentError('Unknown enum value to decode: $data');
          }
...
class OnboardingSurveyRequestGoalPaceEnum {
  ...
  static OnboardingSurveyRequestGoalPaceEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestGoalPaceEnumTypeTransformer().decode(value);

  static List<OnboardingSurveyRequestGoalPaceEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestGoalPaceEnumTypeTransformer {
  factory OnboardingSurveyRequestGoalPaceEnumTypeTransformer() => _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestGoalPaceEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'SLOW':
...
class OnboardingSurveyRequestBiggestChallengeEnum {
  ...
  static const CONSISTENCY =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'CONSISTENCY');
  static const CRAVINGS =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'CRAVINGS');
  static const MOTIVATION =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'MOTIVATION');
  static const EMOTIONAL_EATING =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'EMOTIONAL_EATING');
  static const LACK_OF_KNOWLEDGE =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'LACK_OF_KNOWLEDGE');
  static const NEED_EASIER_TOOL =
      OnboardingSurveyRequestBiggestChallengeEnum._(r'NEED_EASIER_TOOL');
  ...
  static OnboardingSurveyRequestBiggestChallengeEnum? fromJson(dynamic value) =>
      OnboardingSurveyRequestBiggestChallengeEnumTypeTransformer()
          .decode(value);

  static List<OnboardingSurveyRequestBiggestChallengeEnum> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
class OnboardingSurveyRequestBiggestChallengeEnumTypeTransformer {
  factory OnboardingSurveyRequestBiggestChallengeEnumTypeTransformer() =>
      _instance ??=
  ...
  /// The [allowNull] is very handy when an API changes and a new enum value is added or removed,
  /// and users are still using an old app with the old code.
  OnboardingSurveyRequestBiggestChallengeEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'CONSISTENCY':
