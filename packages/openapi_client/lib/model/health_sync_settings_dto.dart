...
class HealthSyncSettingsDto {
  /// Returns a new [HealthSyncSettingsDto] instance.
  HealthSyncSettingsDto({
    this.readSteps,
  ...
  /// Returns a new [HealthSyncSettingsDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static HealthSyncSettingsDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<HealthSyncSettingsDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = HealthSyncSettingsDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, HealthSyncSettingsDto> mapFromJson(dynamic json) {
    final map = <String, HealthSyncSettingsDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = HealthSyncSettingsDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
