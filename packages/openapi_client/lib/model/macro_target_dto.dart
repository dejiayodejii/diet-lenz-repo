...
class MacroTargetDto {
  /// Returns a new [MacroTargetDto] instance.
  MacroTargetDto({
    this.calories,
    this.proteinGrams,
    this.carbsGrams,
  ...
  /// Returns a new [MacroTargetDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MacroTargetDto? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<MacroTargetDto> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MacroTargetDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MacroTargetDto> mapFromJson(dynamic json) {
    final map = <String, MacroTargetDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MacroTargetDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
