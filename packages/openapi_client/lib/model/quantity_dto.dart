...
class QuantityDto {
  ...
  bool operator ==(Object other) =>
      ...
      other is QuantityDto && other.value == value && other.unit == unit;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "QuantityDto[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "QuantityDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static Map<String, List<QuantityDto>> mapListFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = QuantityDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
