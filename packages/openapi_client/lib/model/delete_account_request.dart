...
class DeleteAccountRequest {
  ...
  @override
  String toString() => 'DeleteAccountRequest[password=$password]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "DeleteAccountRequest[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "DeleteAccountRequest[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<DeleteAccountRequest> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<DeleteAccountRequest>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = DeleteAccountRequest.listFromJson(
          entry.value,
          growable: growable,
        );
      }
