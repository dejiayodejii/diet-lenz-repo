...
class MacroSummary {
  ...
  @override
  String toString() =>
      'MacroSummary[dailyCalories=$dailyCalories, proteinGrams=$proteinGrams, carbsGrams=$carbsGrams, fatGrams=$fatGrams, fiberGrams=$fiberGrams]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "MacroSummary[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "MacroSummary[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MacroSummary> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MacroSummary>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MacroSummary.listFromJson(
          entry.value,
          growable: growable,
        );
      }
