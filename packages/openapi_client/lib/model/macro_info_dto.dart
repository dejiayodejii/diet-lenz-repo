...
class MacroInfoDto {
  ...
  @override
  String toString() =>
      'MacroInfoDto[calories=$calories, proteinGrams=$proteinGrams, carbsGrams=$carbsGrams, fatGrams=$fatGrams, fiberGrams=$fiberGrams]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "MacroInfoDto[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "MacroInfoDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<MacroInfoDto> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<MacroInfoDto>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = MacroInfoDto.listFromJson(
          entry.value,
          growable: growable,
        );
      }
