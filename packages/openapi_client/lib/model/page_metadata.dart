...
class PageMetadata {
  ...
  @override
  String toString() =>
      'PageMetadata[size=$size, number=$number, totalElements=$totalElements, totalPages=$totalPages]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "PageMetadata[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "PageMetadata[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<PageMetadata> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<PageMetadata>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = PageMetadata.listFromJson(
          entry.value,
          growable: growable,
        );
      }
