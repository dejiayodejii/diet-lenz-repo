...
class PageUserNotification {
  ...
  @override
  String toString() => 'PageUserNotification[totalPages=$totalPages, totalElements=$totalElements, size=$size, content=$content, number=$number, sort=$sort, pageable=$pageable, numberOfElements=$numberOfElements, first=$first, last=$last, empty=$empty]';
