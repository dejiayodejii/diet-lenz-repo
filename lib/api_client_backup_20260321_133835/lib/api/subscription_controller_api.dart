...
class SubscriptionControllerApi {
  ...
  Future<Response> applyReferralWithHttpInfo(Map<String, String> requestBody,) async {
  ...
  ///
  /// * [Map<String, String>] requestBody (required):
  Future<Object?> applyReferral(Map<String, String> requestBody,) async {
    final response = await applyReferralWithHttpInfo(requestBody,);
  ...
  ///
  /// * [Map<String, String>] requestBody (required):
  Future<Response> verifyAppleSubscriptionWithHttpInfo(Map<String, String> requestBody,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [Map<String, String>] requestBody (required):
  Future<UserSubscriptionDto?> verifyAppleSubscription(Map<String, String> requestBody,) async {
    final response = await verifyAppleSubscriptionWithHttpInfo(requestBody,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
  ...
  ///
  /// * [Map<String, String>] requestBody (required):
  Future<Response> verifyGoogleSubscriptionWithHttpInfo(Map<String, String> requestBody,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [Map<String, String>] requestBody (required):
  Future<UserSubscriptionDto?> verifyGoogleSubscription(Map<String, String> requestBody,) async {
    final response = await verifyGoogleSubscriptionWithHttpInfo(requestBody,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
