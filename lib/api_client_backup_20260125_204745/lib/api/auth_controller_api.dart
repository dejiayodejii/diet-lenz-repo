...
class AuthControllerApi {
  ...
  Future<Response> requestPasswordReset1WithHttpInfo(ForgotPasswordRequest forgotPasswordRequest,) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [ForgotPasswordRequest] forgotPasswordRequest (required):
  Future<String?> requestPasswordReset1(ForgotPasswordRequest forgotPasswordRequest,) async {
    final response = await requestPasswordReset1WithHttpInfo(forgotPasswordRequest,);
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
    }
    // When a remote server returns no body with a status of 204, we shall not decode it.
