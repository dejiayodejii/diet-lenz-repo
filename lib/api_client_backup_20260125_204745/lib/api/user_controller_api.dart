...
class UserControllerApi {
  ...
  /// Performs an HTTP 'POST /api/v1/users/password/forgot' operation and returns the [Response].
  /// Parameters:
  ///
  ...
  Future<Response> requestPasswordResetWithHttpInfo(ForgotPasswordRequest forgotPasswordRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/users/password/forgot';
  ...
  /// Performs an HTTP 'POST /api/v1/users/password/reset' operation and returns the [Response].
  /// Parameters:
  ///
  ...
  Future<Response> resetPasswordWithHttpInfo(ResetPasswordRequest resetPasswordRequest,) async {
    // ignore: prefer_const_declarations
    final path = r'/api/v1/users/password/reset';
