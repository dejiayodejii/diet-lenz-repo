...
class PageUserNotification {
  ...
  @override
  String toString() => 'PageUserNotification[totalPages=$totalPages, totalElements=$totalElements, size=$size, content=$content, number=$number, pageable=$pageable, sort=$sort, numberOfElements=$numberOfElements, first=$first, last=$last, empty=$empty]';
