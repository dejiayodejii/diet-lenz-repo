...
class SuggestedFoodAnalysis {
  /// Returns a new [SuggestedFoodAnalysis] instance.
  SuggestedFoodAnalysis({
    this.foodName,
    this.description,
  ...
  bool operator ==(Object other) => identical(this, other) || other is SuggestedFoodAnalysis &&
    ...
    other.suggestedImage == suggestedImage;
  ...
  int get hashCode =>
    ...
    (suggestedImage == null ? 0 : suggestedImage!.hashCode);

  @override
  String toString() => 'SuggestedFoodAnalysis[foodName=$foodName, description=$description, ingredients=$ingredients, totalMacros=$totalMacros, recipeSteps=$recipeSteps, imageBase64=$imageBase64, suggestedImage=$suggestedImage]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.suggestedImage != null) {
      json[r'suggestedImage'] = this.suggestedImage;
    } else {
      json[r'suggestedImage'] = null;
    }
    return json;
  }

  /// Returns a new [SuggestedFoodAnalysis] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SuggestedFoodAnalysis? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SuggestedFoodAnalysis(
        ...
        suggestedImage: mapValueOfType<String>(json, r'suggestedImage'),
      );
    }
    return null;
  }
  ...
  static List<SuggestedFoodAnalysis> listFromJson(dynamic json, {bool growable = false,}) {
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SuggestedFoodAnalysis.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SuggestedFoodAnalysis> mapFromJson(dynamic json) {
    final map = <String, SuggestedFoodAnalysis>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SuggestedFoodAnalysis.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
