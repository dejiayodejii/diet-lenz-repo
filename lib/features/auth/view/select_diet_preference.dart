...
class SelectDietPreferencecreen extends ConsumerStatefulWidget {
  const SelectDietPreferencecreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _LoginScreenState();
}

class _LoginScreenState extends ConsumerState<SelectDietPreferencecreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final goals = recipeState.dietaryPreferences ??
        [
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("What is your dietary preference?",
                style: TextStyle(
                    fontSize: 24,
                    letterSpacing: 0,
