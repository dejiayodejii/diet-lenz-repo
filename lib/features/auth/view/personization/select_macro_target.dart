...
import 'package:diet_lenz/features/auth/view/select_diet_preference.dart';
import 'package:diet_lenz/features/recipe/controller/recipe_viewmodel.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flutter_svg/svg.dart';

class SelectMacroTargetScreen extends ConsumerStatefulWidget {
  const SelectMacroTargetScreen({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _LoginScreenState();
}

class _LoginScreenState extends ConsumerState<SelectMacroTargetScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final goals = recipeState.macroTargets ??
        [
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("What is your macro target?",
                style: TextStyle(
                    fontSize: 24,
                    letterSpacing: 0,
            ...
            CustomYafButton(
                ...
                onPressed: () {
                  // Save selected macro target
                  ref
                      .read(onboardingProfileProvider.notifier)
                      .updateMacroTarget(goals[selectedIndex]);
